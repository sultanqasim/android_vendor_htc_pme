...
LOCAL_MULTILIB := both
LOCAL_PROPRIETARY_MODULE := true
LOCAL_SRC_FILES_64 := proprietary/lib64/libsdmcore.so
LOCAL_SRC_FILES_32 := proprietary/lib/libsdmcore.so
include $(BUILD_PREBUILT)
...
LOCAL_MULTILIB := both
LOCAL_PROPRIETARY_MODULE := true
LOCAL_SRC_FILES_64 := proprietary/lib64/libsdmutils.so
LOCAL_SRC_FILES_32 := proprietary/lib/libsdmutils.so
include $(BUILD_PREBUILT)
